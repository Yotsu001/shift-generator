...
RSpec.describe ShiftDay, type: :model do
  ...
  describe '従業員関連メソッド' do
    ...
    it 'assignment_for と leave_request_for は対象レコードを返すこと' do
      ...
      other_shift_day = create(:shift_day, period_start_date: shift_day.target_date + 1.day,
                                           period_end_date: shift_day.target_date + 3.days, target_date: shift_day.target_date + 1.day)
